...
public class Calculator extends JFrame {
	...
	public Calculator() {
		...
		doubleCalculate.setBounds(633, 66, 89, 23);
		...
		intCalculate.setBounds(633, 152, 89, 23);
		...
		stringCalculate.setBounds(633, 244, 89, 23);
		...
		booleanCalculate.setBounds(633, 317, 89, 23);
		...
		toggleD.setFont(new Font("Lucida Grande", Font.PLAIN, 6));
		...
		toggleD.setBounds(596, 66, 27, 23);
		getContentPane().add(toggleD);

		toggleI = new JToggleButton("copy");
		toggleI.setFont(new Font("Lucida Grande", Font.PLAIN, 6));
		...
		toggleI.setBounds(596, 152, 27, 23);
		getContentPane().add(toggleI);

		toggleS = new JToggleButton("copy");
		toggleS.setFont(new Font("Lucida Grande", Font.PLAIN, 6));
		...
		toggleS.setBounds(596, 244, 27, 23);
		getContentPane().add(toggleS);

		toggleB = new JToggleButton("copy");
		toggleB.setFont(new Font("Lucida Grande", Font.PLAIN, 6));
		...
		toggleB.setBounds(596, 317, 27, 23);
	...
	public void solveString(String operator){
		...
		//			if(stringField1.getText().contains(stringField2.getText()))
		//				stringResult.setText("true");
		//			else
		//				stringResult.setText("false");
		//		}else{// Makes  a substring from the first text Field, from the first and last character in the second text field.
		//			stringResult.setText(stringField1.getText().substring(Integer.parseInt(stringField2.getText().substring(0, 1)),
		//					Integer.parseInt(stringField2.getText().substring(stringField2.getText().length() -1)))); 
		//		}

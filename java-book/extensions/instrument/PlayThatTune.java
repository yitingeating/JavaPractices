...
public class PlayThatTune {
    ...
    public static void main(String[] args) {
        ...
        int numerator=ap.nextInt("Numerator");
        int denominator=ap.nextInt("Denominator");
        double strength=ap.nextDouble("Strength");
        ...
        while (!StdIn.isEmpty()) {
            ...
            for (int i = 0; i <= N; i++) {
                a[i] =strength* Math.sin(2 * Math.PI * i * ((double)numerator/denominator)*hz / StdAudio.SAMPLE_RATE);
            }
